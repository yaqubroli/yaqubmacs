...
#+end_src
*** svg-tag-mode
First, I'll define a function (~yaqub/svg-tag-setup~) which declares all the variables in Rougier's [[https://github.com/rougier/svg-tag-mode/blob/main/examples/example-2.el][example 2]], and also copy-paste functions from the example
#+begin_src emacs-lisp
  ...
  (defun yaqub/svg-tag-mode-setup ()
